...
$email_search = "SELECT * FROM ragistration_form WHERE user_id = '$id'";
...
<td class="tdd"><a href="modifytwo.php?id=<?php echo $row['id']; ?>" title="click to view form">Editform</a></td>
</tr>
</table>
</body>
</html>
